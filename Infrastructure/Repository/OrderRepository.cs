...
public class OrderRepository : IOrderRepository
{
    ...
    public async Task<List<Order>> GetAllUnFinaledOrders()
    {
        ...
        return await _datacontext.Orders.Where(o => o.IsFinaly == false && o.IsDelete == false)
                                        .ToListAsync();
    ...
    public async Task<List<Order>> GetAllFinaledOrders()
    {
        ...
        return await _datacontext.Orders.Where(o => o.IsFinaly == true && o.IsDelete == false)
                                        .ToListAsync();
    ...
    {
        return await _datacontext.Orders.FirstOrDefaultAsync(o => o.UserId == UserId && o.IsDelete == false);
    }
    ...
    #region GetUnFinaledOrderByOrderID

    public async Task<Order?> GetUnFinaledOrderByOrderId(int OrderId)
    {
        return await _datacontext.Orders.FirstOrDefaultAsync(o => o.Id == OrderId &&
                                                              o.IsFinaly == false &&
                                                              o.IsDelete == false);
    }
    ...
    public async Task<List<OrderDetail>> GetAllOrderDetailsByOrderId(int OrderId)
    {
        ...
        Order? order = await _datacontext.Orders
                      .FirstOrDefaultAsync(o => o.Id == OrderId && o.IsDelete == false);
    ...
    public async Task<Location?> GetLocationByOrderId(int OrderId)
    {
        ...
        return await _datacontext.Locations.FirstOrDefaultAsync(l => l.OrderId == OrderId);
    }
